    ...
    <header className="sticky top-0 z-40 border-b border-slate-200/80 bg-[#f7f8f5]/90 backdrop-blur-xl">
      <div className="mx-auto flex max-w-7xl flex-col gap-4 px-4 py-4 sm:px-6 lg:flex-row lg:items-center lg:justify-between lg:px-8">
        ...
        <div className="flex items-center gap-3">
          <span className="grid h-11 w-11 place-items-center rounded-2xl border border-teal-200 bg-teal-50 text-teal-700 shadow-sm">
          ...
          <div>
            ...
            <p className="mt-0.5 text-xs text-slate-500">
              Incident awareness and practical safety guidance
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <span className="hidden text-xs text-slate-500 xl:inline">
            Updated {updatedAt} · {totalCount} records
          </span>
